      ...
      <body className="min-h-full flex flex-col">
        ...
        <header className="sticky top-0 z-40 border-b border-line bg-canvas/85 backdrop-blur-md">
          <nav className="mx-auto flex h-14 max-w-5xl items-center px-6">
            <Link
              href="/"
              className="eyebrow !text-ink transition-colors hover:!text-muted"
            >
              Prime Radiant
            </Link>
          </nav>
        ...
        <footer className="relative z-10 border-t border-line">
          <div className="mx-auto flex max-w-5xl flex-col gap-3 px-6 py-10 text-[0.8125rem] text-muted sm:flex-row sm:items-center sm:justify-between">
            ...
            <p className="flex items-center gap-2.5 font-mono text-[0.6875rem] tracking-wider uppercase">
              Follow the progress
              {/* The marks are the links; the words are not. Padding is pulled
                  back by the negative margin so a 12px glyph still gets a 24px
                  hit area without shifting the baseline. */}
              <span className="flex items-center gap-1">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  aria-label="Prime Radiant source on GitHub"
                  title="Prime Radiant source on GitHub"
                  className="-m-1.5 inline-flex p-1.5 text-muted transition-colors hover:text-ink"
                >
